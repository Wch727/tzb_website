...
本展项把毛泽东放在长征由危转安的历史关口中来呈现。1934 年底，中央红军在连续突围中付出重大代价，湘江战役以后，摆在党和红军面前的已经不是一般性的行军问题，而是怎样保存革命力量、怎样重新判断前进方向的问题。

在这一时期，毛泽东长期积累的根据地斗争经验和军事斗争经验，开始在更严峻的环境中显示出分量。通道转兵、黎平会议、猴场会议到遵义会议，红军的行军方向和领导方式逐步调整。毛泽东强调从中国革命实际出发，强调根据敌情、地形和部队状况灵活用兵，这与长征初期机械僵化的指挥形成鲜明对照。

遵义会议以后，新的战略判断开始转化为行动能力。四渡赤水期间，红军不是沿着一条直线突围，而是在赤水河两岸反复机动，调动敌军，寻找战机，逐步摆脱被动局面。由此可以看到，毛泽东在长征中的作用，并不只是某一次会议中的发言，而是在危局中推动战略主动权重新形成。

参观这一人物专题，应当把“方向”二字作为理解线索。长征中的毛泽东，使党和红军在极端困难中重新看清道路，也使中国革命在实践中进一步形成符合自身实际的领导方法和斗争方法。

资料依据：中国共产党新闻网、人民网党史资料等公开资料。""",
        "周恩来": """《周恩来》人物专题讲解词

本展项呈现的周恩来，不只是长征中的重要领导人，更是危急局面中的组织者、协调者和执行者。长征是一场牵动中央机关、前线部队、后方转移和领导关系调整的巨大行动，越是在局势复杂的时候，越能看出组织能力的分量。

湘江战役以后，红军遭受重大损失，队伍继续西进，党内对军事指导和行动方向的反思不断加深。周恩来处在军事指挥和中央领导工作的关键位置。他一方面要面对前线作战和部队转移的实际压力，另一方面也要维护领导集体的团结，推动新的认识逐步形成。

遵义会议前后，周恩来的作用尤其值得注意。他参与重要讨论，也在会议之后继续承担军事指挥和组织协调责任。会议能够成为转折点，既需要形成正确判断，也需要有人把判断落实到队伍行动中。周恩来的贡献，正体现在这种把方向、组织和执行连接起来的能力上。

因此，参观周恩来专题，重点不只是看一个人物的职务，而是看一支革命队伍在极端困难中如何保持团结、如何调整方向、如何继续前进。周恩来所体现的，是长征中稳定全局、凝聚力量、推动落实的历史作用。

资料依据：中国共产党新闻网、周恩来纪念网等公开资料。""",
        "朱德": """《朱德》人物专题讲解词

朱德这一展项，适合放在整条长征路线中观看。作为红军总司令，他的作用并不集中在某一个瞬间，而是贯穿于部队行军、作战、整合和会师的全过程。长征越漫长，越能看出这种稳定统率力量的重要。

中央红军开始战略转移后，部队在敌军围追堵截中连续行军作战。前方有封锁线，后方有追兵，内部还要保持纪律、士气和组织秩序。朱德凭借长期军事领导经验和在红军中的威望，为主力部队持续推进提供了重要支撑。

翻雪山、过草地这样的艰苦阶段，尤其能够说明朱德的历史分量。那不是一场战斗、一条命令就能解决的问题，而是对整支队伍体力、信念、纪律和组织力的全面考验。朱德所代表的，正是红军在长期艰难推进中仍然能够保持队形、保持信心、保持方向的力量。

会师是长征的重要结局，但会师不是自然发生的。多支红军力量能够在极端困难中保存下来并最终汇合，离不开长期的统率、协调和坚持。朱德专题让人看到，长征胜利的背后，不仅有转折会议和经典战例，也有始终支撑队伍走到底的军事领导力量。

资料依据：中国共产党新闻网等公开资料。""",
        "张闻天": """《张闻天》人物专题讲解词

张闻天这一展项的重点，不在于罗列职务，而在于说明遵义会议前后党内认识怎样发生变化。长征的转折并不是突然出现的，它经历了危机中的反思、会议中的辨明，也经历了领导责任和组织关系的调整。

湘江战役以后，红军遭受重大损失，党内对原有军事指导的反思迅速加深。张闻天作为党的早期重要领导人和理论工作者，在这一过程中逐步支持更加符合中国革命实际的战略判断。他的作用，不是体现在战场冲锋，而是体现在党内讨论、会议酝酿和领导调整这些关键环节中。

遵义会议前后，张闻天参与推动形成新的认识和新的领导格局。会议之后，转折要真正成为现实，还必须落实到组织运行和实际决策中。张闻天在中央领导工作中承担重要责任，使会议形成的方向能够进一步进入行动层面。

观看张闻天专题，应当看到长征转折的深层机制：它不是个人英雄叙事，也不是简单的会议结论，而是党在危机中纠正错误、重新认识实际、形成正确领导的过程。张闻天的历史位置，正落在这一思想与组织转换的关键处。

资料依据：人民网党史频道等公开资料。""",
        "王稼祥": """《王稼祥》人物专题讲解词

王稼祥这一展项提示我们，历史转折并不总是由最显眼的人物单独完成。在长征这样的重大历史进程中，正确方向的形成，既需要有人提出判断，也需要有人识别、支持并推动这一判断成为集体行动。

长征初期，红军在连续突围中陷入严峻局面。湘江战役以后，原有军事指导的问题已经无法回避。王稼祥在这一时期的重要作用，集中体现在遵义会议前后对正确方向的支持上。他的判断和表态，为新的领导格局形成提供了重要组织力量。

遵义会议之所以成为转折点，不只是因为会议作出了新的结论，更因为这些结论获得了党内重要干部的支持，并逐步转化为稳定的领导关系和行动方向。王稼祥的价值，正是在这一过程中体现出来的。

参观王稼祥专题，可以帮助理解长征转折的集体性。长征不是由孤立人物推动的历史，而是在危机压力、实践检验和党内共同努力中完成的转折。王稼祥所代表的，是关键时刻支持正确路线、共同推动历史前进的力量。

资料依据：中国共产党新闻网等公开资料。""",
        "刘伯承": """《刘伯承》人物专题讲解词

刘伯承这一展项，应当放在长征的军事行动链条中理解。长征不是地图上一条简单的行军线，而是一连串渡河、穿插、突击、掩护和突破组成的艰难行动。战略方向确定以后，能不能在战场上执行出来，同样决定着红军的命运。

红军进入贵州、四川一带后，地形更加复杂，敌情更加多变。渡河要抢时间，穿插要避重兵，突击要抓战机，部队协同也必须严密。刘伯承长期积累的军事经验，使他能够在复杂形势中冷静判断、组织行动、完成突破任务。

强渡大渡河、飞夺泸定桥等节点，之所以成为长征史中的经典，并不只是因为场面惊险。它们背后有侦察、部署、突击、协同和指挥，有对地形与敌情的准确把握，也有指挥员在关键时刻的果断决断。刘伯承这一人物线索，正能把这些军事细节呈现出来。

观看刘伯承专题，可以更具体地理解长征的军事智慧。长征既是信念和意志的远征，也是组织能力、战场判断和执行能力的集中检验。刘伯承所体现的，正是把战略要求转化为实际战果的力量。

资料依据：中国共产党新闻网等公开资料。""",
        "聂荣臻": """《聂荣臻》人物专题讲解词

聂荣臻这一展项，适合从“组织支撑”四个字进入。长征走到最艰难的阶段，考验一支队伍的不只是能不能打下一场仗，更是能不能在长时间行军、饥寒疲惫、敌军压力和自然险阻中保持秩序、保持战斗力、保持继续前进的信心。

聂荣臻长期承担重要军事工作。他在长征中的作用，不是靠某一个孤立场面来呈现，而是体现在持续的组织、协同和保障之中。部队要快速机动，要面对复杂地形，要在连续作战后继续保持战斗力，这些都需要稳定可靠的军事领导和政治工作。

翻雪山、过草地以及北上推进的艰苦阶段，尤其能说明这种支撑力量的重要。越是极端环境，越能看出组织工作的分量。没有这种力量，队伍可能在自然困难面前被拖垮，也可能在长期疲惫中失去秩序。

观看聂荣臻专题，不是为了寻找一个单独的传奇瞬间，而是为了看到长征胜利背后那些持续运转的力量。伟大征程并不只由高潮组成，也由许多沉稳、坚韧、连续的工作共同托举起来。聂荣臻所代表的，正是这种不喧哗却可靠的历史力量。

资料依据：中国共产党新闻网等公开资料。""",
        "彭德怀": """《彭德怀》人物专题讲解词

彭德怀这一展项，最鲜明的是战斗气质。长征途中，红军既要摆脱敌军围追，又要在关键时刻敢于出击；既要保存力量，也要在必要时打硬仗。彭德怀所体现的，正是一线将领在重压之下敢于承担、善于组织、勇于作战的精神面貌。

彭德怀长期以作风硬朗、指挥果断著称。在湘江战役前后、北上行军途中以及到达陕北后的作战中，都可以看到他所代表的这种战斗作风。它不是抽象的勇猛，而是在具体任务面前顶得上去，在复杂局面中扛得下来。

长征中的革命英雄主义，并不是空泛的赞美。它体现在面对封锁时敢于突破，面对压力时保持斗志，面对艰巨任务时能够组织部队完成行动。彭德怀这一人物线索，让观众更直接地看到长征中“敢打硬仗”的现实基础。

参观彭德怀专题，应当把他放回红军连续作战的历史现场中理解。长征的胜利，不只来自路线调整，也来自一批能打硬仗、敢担重任的红军将领和广大指战员。彭德怀所代表的，正是这支队伍在困境中保持战斗意志的一面。
...
try:
    from figure_narratives import POLISHED_FIGURE_LECTURE_SCRIPTS

    FIGURE_LECTURE_SCRIPTS.update(POLISHED_FIGURE_LECTURE_SCRIPTS)
except Exception:
    pass
