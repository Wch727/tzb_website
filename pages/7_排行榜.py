...
from leaderboard import get_activity_leaderboard, get_global_leaderboard, get_user_battles
...
tab1, tab2, tab3 = st.tabs(["全局排行榜", "活动排行榜", "个人战绩"])
...
with tab3:
    ...
    if rows:
        ...
        share_text = (
            ...
            f"当前军衔为 {latest.get('rank_title', '')}，欢迎一起重走长征路。"
        )
