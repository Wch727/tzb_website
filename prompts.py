...
3. 写成博物馆讲解员口吻：先把观众带到具体场景，再解释历史逻辑。
4. 必须包含以下小节：开场引入、历史背景、事件经过、历史意义、结尾收束。
5. 每个小节至少写 2 句，尽量使用时间、地点、人物、路线、动作细节，不要只有抽象判断。
6. 风格正式、清晰、有画面感，适合比赛展示、现场导览和展项讲解。
7. 内容必须建立在参考资料基础上，避免空泛抒情、避免堆砌口号、避免重复使用“不是……而是……”句式。
8. 如果资料有限，也要优先整合已有信息写成一篇完整讲解稿。
...
4. 风格要像博物馆讲解员：有现场感、有路线感、有历史解释，不要像课本摘要。
5. 多写具体场景和细节，少写抽象套话。
